...
| Visual Studio Marketplace | [Heossi.beecode](https://marketplace.visualstudio.com/items?itemName=Heossi.beecode) | `0.2.11` | `proprietary-vscode-extension` | Proprietary | `code --install-extension Heossi.beecode` |
